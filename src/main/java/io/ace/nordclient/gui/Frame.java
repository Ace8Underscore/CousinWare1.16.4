...
public class Frame {
    ...
    public void renderFrame(MatrixStack matrixStack, final FontRenderer fontRenderer) {
        ...
        Color t = new Color(165, 145, 44);

        AbstractGui.fill(matrixStack ,this.x, this.y, this.x + this.width, this.y + this.barHeight, c.getRGB());
        ...
        AbstractGui.fill(matrixStack, this.x, this.y + 17, this.x + 80 + 15, this.y + 15, t.getRGB());
        ...
        //if (!Core.customFont.getValBoolean())
            FontRenderUtil.drawCenteredStringWithShadow(matrixStack, this.category.name(), (float) (this.x + 47.5), this.y + 3, -1);
       // else
       //     FontRenderUtil.drawCenteredStringWithShadowCustom(this.category.name(), (float) (this.x + 47.5), this.y + 3, -1);
